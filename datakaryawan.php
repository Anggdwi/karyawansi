    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                             ...
                             <form class="form-header" action="prospenkar.php" method="POST">
                                <input class="au-input au-input--xl" autocomplete="off" type="text" name="cari" placeholder="Cari NIK atau nama karyawan" />
            ...
            <div class="main-content">
                            ...
                            <form action="dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Tempat Lahir</td>
                                                <td><input type="text" class="form-control" required="" name="tempat_lahir" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Lahir</td>
                                                <td><input type="date" class="form-control" required="" name="tanggal_lahir" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kelamin</td>
                                                <td>
                                ...
                                <a href="karyawan_print.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-print fa-sm text-white-60"></i> Print Data</a> 
                        </div>
                        <?php 
                        include 'koneksi.php';
                ...
                ?>              
                <li class="page-item">
                    <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?halaman=$next'"; } ?>>Lanjut</a>
                </li>
            </ul>
