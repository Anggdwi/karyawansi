        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item"><a class="nav-link" href="#login" rel="page-scroll"></a></li> 
           
              
							</li>
              <li class="nav-item"><a class="nav-link" href="#kontak" rel="page-scroll"></a></li>
            </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12 zero-panel-content">
            <center><p><h1>ABSENSI</p></h1></center>
              <center><h1>CV.KOSMETIK AYSHOP</h1></center>
